<?php
//http://localhost/Tutorial/Admin/web/index.php
		...
		<div id="page-wrapper">
        	...
        	<div class="col-md-4 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>Dhs <?php echo count_total_order_value($connect); ?></strong></h5>
        		...
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-dollar icon-rounded"></i>
                    <div class="stats">
                      <h5><strong><?php echo count_total_category($connect); ?></strong></h5>
                      <span>les nombres des categories</span>
                    </div>
                </div>
					</div>
					</div>
        		...
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-dollar icon-rounded"></i>
                    <div class="stats">
                      <h5><strong><?php echo count_total_brand($connect); ?></strong></h5>
                      <span>Total des Marques </span>
                    </div>
                </div>
					</div>
        		...
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-dollar icon-rounded"></i>
                    <div class="stats">
                      <h5><strong><?php echo count_total_product($connect); ?></strong></h5>
                      <span>Total Item in Stock</span>
                    </div>
                </div>
					</div>
					</div>
        		...
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-dollar icon-rounded"></i>
                    <div class="stats">
                      <h5><strong>Dhs <?php echo count_total_cash_order_value($connect); ?></strong></h5>
        		...
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-dollar icon-rounded"></i>
                    <div class="stats">
                      <h5><strong>Dhs <?php echo count_total_credit_order_value($connect); ?></strong></h5>
                      <span>Profit credit</span>
                    </div>
                </div>
					</div>
					</div>
        		...
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-dollar icon-rounded"></i>
                    <div class="stats">
                      <h5><strong>Dhs <?php  count_profit_store($connect); ?></strong></h5>
        	...
        	<div class="col-md-5 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>Dhs <?php echo  count_sum_caiss_entree($connect) - count_sum_caiss_sortie($connect) ; ?></strong></h5>
                      <span>total de la caisse d'aujourd'hui</span>
                    </div>
            </div>
        	</div>
					</div>
