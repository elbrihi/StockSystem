...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1">Gestion de la Caisse</h2>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
									<div class="row">
										<h3 class="panel-title">la liste de toutes les operation de la caise</h3>
									</div>
								</div>
								<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
									<div class="row" align="right">
										<button type="button" name="add" id="add_button" data-toggle="modal" data-target="#caisseModal" class="btn btn-success btn-xs">Add</button>   		
									</div>
								</div>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-12 table-responsive">
										<table id="caisse_data" class="table table-bordered table-striped">
											<thead><tr>
												<th>ID</th>
												<th>Designation</th>
												<th>Type</th>
				...
				<div id="caisseModal" class="modal fade">
					<div class="modal-dialog">
						<form method="post" id="caisse_form">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal">&times;</button>
									<h4 class="modal-title"><i class="fa fa-plus"></i> entre l'operation de la caisse </h4>
								</div>
									    ...
									    <div class="form-group">	
													<div class="col-md-5">
														<label class="radio-inline">  
															<input type="radio" name="type" value="entree" />l'entree  <br />  
														</label>
													</div>
													<div class="col-md-5">
														<label class="radio-inline">
															<input type="radio" name="type" value="sortie" checked="checked" />sortie <br />
														</label>
													</div>
											</div>
									</div>
								...
								<div class="modal-footer">
									<input type="hidden" name="caisse_id" id="caisse_id"/>
  ...
  <script>
	$(document).ready(function(){
		...
		$('#add_button').click(function(){
			$('#caisse_form')[0].reset();
			$('.modal-title').html("<i class='fa fa-plus'></i> Entree une operation de la caisse");
			$('#action').val('Add');
			$('#btn_action').val('Add');
		});

		$(document).on('submit','#caisse_form', function(event){
			console.log(5);
			event.preventDefault();
			$('#action').attr('disabled','disabled');
			var form_data = $(this).serialize();
			$.ajax({
				url:"caisse_action.php",
				method:"POST",
				data:form_data,
				success:function(data)
				{
					...
					caissedataTable.ajax.reload();
				}
			})
		});

		$(document).on('click', '.update', function(){
			var caisse_id = $(this).attr("id");
			var btn_action = 'fetch_single';
			$.ajax({
				url:"caisse_action.php",
				method:"POST",
				data:{caisse_id:caisse_id, btn_action:btn_action},
				dataType:"json",
				success:function(data)
				{
					...
					$('.modal-title').html("<i class='fa fa-pencil-square-o'></i> Modifiee La Caisse");
					$('#caisse_id').val(data.caisse_id);
					$('#action').val('Edit');
					$('#btn_action').val("Edit");
				}
			})
		...
		var caissedataTable = $('#caisse_data').DataTable({
			"processing":true,
			"serverSide":true,
			"order":[],
			"ajax":{
				url:"caisse_fetch.php",
				type:"POST"
			},
			"columnDefs":[
				{
		...
		$(document).on('click', '.delete', function(){
			...
			if(confirm("Are you sure you want to change status?"))
			{
				$.ajax({
					url:"caisse_action.php",
					method:"POST",
					data:{caisse_id:caisse_id, status:status, btn_action:btn_action},
					success:function(data)
					{
