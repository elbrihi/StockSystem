...
<body class="cbp-spmenu-push">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
									<div class="row">
										<h3 class="panel-title">tous les actions d'utilisateur</h3>
									</div>
									<div class="row">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-20 table-responsive">
										<br />
										<div class="row">
											...
											<div class="col-md-4">
      										<input type="button" name="search" id="search" value="cherche" class="btn btn-info" />
     									</div>
										</div>
										<table id="history_data" class="table table-bordered table-striped">
											<thead><tr>
												<th>ID</th>
												<th>Actions</th>
												<th>date</th>
  ...
  <script>
	$(document).ready(function(){
		...
		{
			var historyTable = $('#history_data').DataTable({
				"processing":true,
				"serverSide":true,
				"order":[],
				"ajax":{
