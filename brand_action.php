...
if(isset($_POST['btn_action']))
{
	if($_POST['btn_action'] == 'Add')
	{
		...
		if(isset($result))
		{
			...
			$statement->execute(
				array(
					':do'	=> $_SESSION['user_name'].' a entree une marque du nom ' . $_POST["brand_name"].'à la date ' . date("Y-m-d"),
					':date' => date("Y-m-d"),
				)
			);
		}
	...
	if($_POST['btn_action'] == 'Edit')
	{
		...
		if(isset($result))
		{
			...
			$statement->execute(
				array(
					':do'	=> $_SESSION['user_name'].' a modifiée une brand à ' . $_POST["brand_name"].'à la date ' . date("Y-m-d"),
					':date' => date("Y-m-d"),
				)
			);
		}
